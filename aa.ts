const ss = {
  feed: {
    ...
    updated: { label: "2024-06-19T08:53:17-07:00" },
    ...
    link: [
      ...
      },
      {
        attributes: {
          rel: "self",
          href: "https://mzstoreservices-int.itunes.apple.com/us/rss/toppodcasts/limit=1/genre=1310/json",
        },
      },
    ],
    id: {
      label:
        "https://mzstoreservices-int.itunes.apple.com/us/rss/toppodcasts/limit=1/genre=1310/json",
    },
  },
};
